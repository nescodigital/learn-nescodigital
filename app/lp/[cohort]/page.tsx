...
const ALL_PLANS = {
  ...
  pro: { name: "PRO", price: "297", yearlyPrice: "238", originalPrice: "495", originalYearlyPrice: "397", period: "lună", features: ["Tot ce include Starter", "Acces prioritar la cursuri noi", "Resurse descărcabile (templates, prompturi, checklist-uri)", "Suport prioritar — răspuns în față față de Starter", "Certificat digital recunoscut (după min. 6 luni)"], description: "Pentru cei care nu își permit să rămână în urmă. Certificat inclus.", buttonText: "Vreau Pro →", href: "#waitlist", isPopular: true, isBusiness: false },

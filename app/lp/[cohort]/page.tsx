...
const ALL_PLANS = {
  starter: { name: "STARTER", price: "197", yearlyPrice: "157", originalPrice: "329", originalYearlyPrice: "262", period: "lună", features: ["Acces la toate cursurile disponibile", "Quiz după fiecare lecție", "Actualizări la cursurile existente", "Suport email", "Certificat digital (după min. 6 luni consecutive)"], description: "Tot ce ai nevoie ca să nu rămâi în urmă.", buttonText: "Rezervă-mi locul →", href: "#waitlist", isPopular: false, isBusiness: false },
  pro: { name: "PRO", price: "297", yearlyPrice: "238", originalPrice: "495", originalYearlyPrice: "397", period: "lună", features: ["Tot ce include Starter", "Cursuri noi cu 15 zile înainte față de Starter", "Toate cursurile noi lansate cât timp ești abonat", "Resurse descărcabile (templates, prompturi, checklist-uri)", "Suport prioritar (răspuns mai rapid)"], description: "Pentru cei care nu își permit să rămână în urmă.", buttonText: "Vreau Pro →", href: "#waitlist", isPopular: true, isBusiness: false },
